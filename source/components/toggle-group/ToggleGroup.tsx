...
const TOGGLE_INPUT_BASE_CLASS = mergeClasses(
  "peer absolute inset-0 m-0 size-full cursor-[inherit] appearance-none border border-solid border-gray-300 bg-white transition-colors duration-100 ease-out checked:border-transparent checked:bg-blue-600 dark:border-gray-600 dark:bg-gray-700 dark:checked:border-transparent dark:checked:bg-blue-500",
