...
const Text0Impl = createTypography({ sizeClasses: SIZE_CLASSES["0"], gapClass: "gap-3", defaultWeight: "bold" });
const Text1Impl = createTypography({ sizeClasses: SIZE_CLASSES["1"], gapClass: "gap-2.5", defaultWeight: "semibold" });
const Text2Impl = createTypography({ sizeClasses: SIZE_CLASSES["2"], gapClass: "gap-2", defaultWeight: "medium" });
const Text3Impl = createTypography({ sizeClasses: SIZE_CLASSES["3"], gapClass: "gap-1.5", defaultWeight: "medium" });
const Text4Impl = createTypography({ sizeClasses: SIZE_CLASSES["4"], gapClass: "gap-1.5", defaultWeight: "medium" });
